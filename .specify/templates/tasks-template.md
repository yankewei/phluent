...
- [ ] TXXX Config schema/validation updates with error coverage
- [ ] TXXX File processing correctness tests (offsets, truncation, `max_bytes`)
- [ ] TXXX UX consistency review (CLI/config/output + docs examples)
